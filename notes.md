...
We add f at the end otherwise the system assumes it is a double data type value by default
...
The difference comes when we are fetching the value `int exVal = 10;`  
