...
//            ps.setString(5, email);
    ...
    public String UserAccountSettings(HttpSession session, Model model)
    {
        if(session.getAttribute("username") == null)
        {
            return "redirect:/login";
    ...
    public String UserSystemSettings(HttpSession session, Model model)
    {
        if(session.getAttribute("username") == null)
        {
            return "redirect:/login";
    ...
    public String UserActivityLog(HttpSession session, Model model)
    {
        if(session.getAttribute("username") == null)
        {
            return "redirect:/login";
    ...
    @GetMapping("/messages")
    public String UserMessages(HttpSession session, Model model)
    {
        if(session.getAttribute("username") == null)
        {
            return "redirect:/login";
